...
const _defaultHomepageSermonUrl =
...
const _defaultYearThemeMobileImage =
    'assets/images/moving_from_glory_to_glory_theme.png';
const _defaultYearThemeDesktopImage =
    'assets/images/moving_from_glory_to_glory_theme.png';

String _homepageString(
...
Widget _homepageSermonPlayer(BuildContext context, String url) {
...
Widget _yearThemeImage({
  required String url,
  required String fallbackAsset,
  required double width,
  required double height,
}) {
  final image = url.trim().isNotEmpty
      ? Image.network(
          url.trim(),
...
Future<void> _openHomepageSermon(String url) async {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, homepageSnapshot) {
        final snapshotData = homepageSnapshot.data?.data();
        final homepageContent = snapshotData is Map<String, dynamic>
            ? snapshotData
            : <String, dynamic>{};
        final latestSermonVideoUrl = _homepageString(
          homepageContent,
          'latestSermonVideoUrl',
          _defaultHomepageSermonUrl,
        );
        final yearThemeMobileImageUrl = _homepageString(
          homepageContent,
          'yearThemeMobileImageUrl',
          '',
        );
        final yearThemeDesktopImageUrl = _homepageString(
          homepageContent,
                                  ...
                                  if (responsiveVisibility(
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: _yearThemeImage(
                                          url: yearThemeMobileImageUrl,
                                          fallbackAsset:
                                              _defaultYearThemeMobileImage,
                                          width: 200.0,
                                          height: 505.5,
                                        ),
                                      ),
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: _yearThemeImage(
                                          url: yearThemeDesktopImageUrl,
                                          fallbackAsset:
                                              _defaultYearThemeDesktopImage,
                                          width: 200.0,
                                          height: 661.6,
                                        ),
                                      ),
