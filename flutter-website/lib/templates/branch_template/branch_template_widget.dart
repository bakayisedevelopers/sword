...
class BranchTemplateWidget extends StatefulWidget {
  const BranchTemplateWidget({super.key, this.branchSlug});

  final String? branchSlug;

  static String routeName = 'BranchTemplate';
  static String routePath = '/:branchSlug';
...
class _BranchTemplateWidgetState extends State<BranchTemplateWidget>
  ...
  String get _routeSlug {
    final explicitSlug = widget.branchSlug?.trim();
    if (explicitSlug != null && explicitSlug.isNotEmpty) {
      return _normalizeSlug(explicitSlug);
    }
    final segments = Uri.base.pathSegments;
    if (segments.isEmpty) {
      return 'emalahleni';
    }
    return _normalizeSlug(segments.last);
  }
  ...
  Stream<List<BranchesRecord>> _selectedBranchStream() {
    final slug = _routeSlug;
    return queryBranchesRecord(
      queryBuilder: (branchesRecord) =>
          branchesRecord.where('slug', isEqualTo: slug).limit(1),
    );
  }

  Map<String, dynamic> _landingPage(BranchesRecord? branch) {
    final rawLandingPage = branch?.snapshotData['landingPage'];
    if (rawLandingPage is Map) {
      return Map<String, dynamic>.from(rawLandingPage);
    }
    return const {};
  }

  String _landingText(
    BranchesRecord? branch,
    List<String> keys,
    String fallback,
  ) {
    final landing = _landingPage(branch);
    for (final key in keys) {
      final value = landing[key];
  ...
  ImageProvider _imageProvider(String? imageUrl, String fallbackAsset) {
  ...
  ImageProvider _branchHeroImageProvider(BranchesRecord? branch) {
    final landing = _landingPage(branch);
    return _imageProvider(
      (landing['heroDesktopImage'] ??
          landing['heroMobileImage'] ??
          landing['heroImage'] ??
          branch?.image) as String?,
      'assets/images/EMalahleni.png',
    );
  }

  ImageProvider _pastorImageProvider(BranchesRecord? branch) {
    final landing = _landingPage(branch);
    return _imageProvider(
      (landing['pastorImageUrl'] ?? landing['pastorImage']) as String?,
      'assets/images/B&Z_no_background_1.png',
    );
  }

  String _branchName(BranchesRecord? branch) {
    final name = branch?.name.trim();
    return name == null || name.isEmpty ? 'EMalahleni' : name;
  }

  String _branchAddress(BranchesRecord? branch) {
    final address = branch?.location.trim();
    return address == null || address.isEmpty
        ? '6 Clarendon Ave, eMalahleni, 1035'
        : address;
  }

  String _pastorBio(BranchesRecord? branch) => _landingText(
        branch,
        const ['pastorBio', 'shortPastorBio'],
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<BranchesRecord>>(
      stream: _selectedBranchStream(),
      builder: (context, branchSnapshot) {
        final selectedBranch = (branchSnapshot.data?.isNotEmpty ?? false)
            ? branchSnapshot.data!.first
            : null;
        final branchName = _branchName(selectedBranch);
                                                                        ...
                                                                        children: [
                                                                          if (responsiveVisibility(
                                                                            ...
                                                                            InkWell(
                                                                              ...
                                                                              onTap: () async {
                                                                                logFirebaseEvent('E_MALAHLENI_Container_cb8zvdpl_ON_TAP');
                                                                        ...
                                                                        children: [
                                                                          if (responsiveVisibility(
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  logFirebaseEvent('E_MALAHLENI_PAGE_LOCATIONS_BTN_ON_TAP');
                                                                          ...
                                                                          if (responsiveVisibility(
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  logFirebaseEvent('E_MALAHLENI_PAGE_WATCH_BTN_ON_TAP');
                                                                                  logFirebaseEvent('Button_navigate_to');
                                                                          ...
                                                                          if (responsiveVisibility(
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  logFirebaseEvent('E_MALAHLENI_PAGE_ABOUT_US_BTN_ON_TAP');
                                                                                  logFirebaseEvent('Button_navigate_to');
                                                                          ...
                                                                          if (responsiveVisibility(
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  logFirebaseEvent('E_MALAHLENI_PAGE_CARE_BTN_ON_TAP');
                                                                                  logFirebaseEvent('Button_navigate_to');
                                                                          ...
                                                                          if (responsiveVisibility(
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  logFirebaseEvent('E_MALAHLENI_PAGE_GIVE_BTN_ON_TAP');
                                                                                  logFirebaseEvent('Button_navigate_to');
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('E_MALAHLENI_PAGE_menu_ICN_ON_TAP');
                                                          ...
                                                          children: [
                                                            FFButtonWidget(
                                                              onPressed:
                                                                  () async {
                                                                logFirebaseEvent(
                                                                    'E_MALAHLENI_CONTACT_E_MALAHLENI_BTN_ON_T');
                                                                logFirebaseEvent(
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'E_MALAHLENI_CircleImage_o705msz8_ON_TAP');
                                                                          logFirebaseEvent(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onChanged:
                                                                            (val) =>
                                                                                safeSetState(() => _model.serviceTimesValue = val?.firstOrNull),
                                                                        selectedChipStyle:
                                                                            ChipStyle(
                                                                          backgroundColor:
                                                                        ...
                                                                        multiselect:
                                                                            false,
                                                                        initialized:
                                                                            _model.serviceTimesValue !=
                                                                                null,
                                                                        alignment:
                                                                            WrapAlignment.center,
                                                                        controller:
                                                                            _model.serviceTimesValueController ??=
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    FFButtonWidget(
                                                                      onPressed:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'E_MALAHLENI_PAGE_Button_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Button_launch_u_r_l');
                                                                        await launchURL(
                                                                            'https://maps.app.goo.gl/EbRD4TRiubj6TJCz6');
                                                                      },
                                                                      text:
                                                                          'Visit',
                                                                      options:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          header:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              decoration: BoxDecoration(),
                                                                              child: Padding(
                                                                                padding: EdgeInsetsDirectional.fromSTEB(18.0, 0.0, 30.0, 0.0),
                                                                                child: Text(
                                                                                  'Service Times',
                                                                              ...
                                                                              children: [
                                                                                Padding(
                                                                                  ...
                                                                                  child: FlutterFlowChoiceChips(
                                                                                    ...
                                                                                    onChanged: (val) => safeSetState(() => _model.serviceTimesMValue = val?.firstOrNull),
                                                                                    ...
                                                                                    rowSpacing: 8.0,
                                                                                    multiselect: false,
                                                                                    initialized: _model.serviceTimesMValue != null,
                                                                                    alignment: WrapAlignment.center,
                                                                                    controller: _model.serviceTimesMValueController ??= FormFieldController<List<String>>(
                                                                                      [
                                                                                        'Adults'
                                                                                      ],
                                                                                    ),
                                                                                ...
                                                                                Padding(
                                                                                  ...
                                                                                  child: Row(
                                                                                    mainAxisSize: MainAxisSize.max,
                                                                                    children: [
                                                                                      if (_model.serviceTimesMValue == 'Adults')
                                                                                        Column(
                                                                                          mainAxisSize: MainAxisSize.max,
                                                                                          crossAxisAlignment: CrossAxisAlignment.start,
                                                                                          children: [
                                                                                      ...
                                                                                      if (_model.serviceTimesMValue == 'Youth')
                                                                                        Column(
                                                                                          mainAxisSize: MainAxisSize.max,
                                                                                          crossAxisAlignment: CrossAxisAlignment.start,
                                                                                          children: [
                                                                                      ...
                                                                                      if (_model.serviceTimesMValue == 'Kids')
                                                                                        Column(
                                                                                          mainAxisSize: MainAxisSize.max,
                                                                                          crossAxisAlignment: CrossAxisAlignment.start,
                                                                                          children: [
                                                                                      ...
                                                                                      if (_model.serviceTimesMValue == 'Online')
                                                                                        Column(
                                                                                          mainAxisSize: MainAxisSize.max,
                                                                                          crossAxisAlignment: CrossAxisAlignment.start,
                                                                                          children: [
                                                                          ...
                                                                          expanded:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                FFButtonWidget(
                                                                                  onPressed: () async {
                                                                                    logFirebaseEvent('E_MALAHLENI_PAGE_Button_ON_TAP');
                                                                                    logFirebaseEvent('Button_update_app_state');
                                                                                    FFAppState().contactBranch = branchName;
                                                                                    safeSetState(() {});
                                                                                    logFirebaseEvent('Button_navigate_to');

                                                                                    context.pushNamed(ContactUsWidget.routeName);
                                                                                  },
                                                                                  text: 'Contact $branchName',
                                                                                  options: FFButtonOptions(
                                                                                    width: 230.0,
                                                                                    height: 55.0,
                                                                                    padding: EdgeInsetsDirectional.fromSTEB(16.0, 0.0, 16.0, 0.0),
                                                                            ...
                                                                            children: [
                                                                              FFButtonWidget(
                                                                                onPressed: ((_model.nameTextController.text == null || _model.nameTextController.text == '') && (_model.cellTextController.text == null || _model.cellTextController.text == '') && (_model.messageTextController.text == null || _model.messageTextController.text == ''))
                                                                                    ? null
                                                                                    : () async {
                                                                                        logFirebaseEvent('E_MALAHLENI_PAGE_SUBMIT_BTN_ON_TAP');
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: MouseRegion(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'E_MALAHLENI_Container_jplauf1d_ON_TAP');
                                                                logFirebaseEvent(
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: MouseRegion(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'E_MALAHLENI_Container_ynf6j3mn_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Container_navigate_to');
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: MouseRegion(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'E_MALAHLENI_Container_5w2mknpv_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Container_navigate_to');
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: MouseRegion(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'E_MALAHLENI_Container_nu04bbbf_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Container_navigate_to');
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: MouseRegion(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'E_MALAHLENI_Container_yakp97t0_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Container_navigate_to');
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: MouseRegion(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'E_MALAHLENI_Container_ws8zvi9j_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Container_navigate_to');
                                                      ...
                                                      children: [
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'E_MALAHLENI_Container_81l1pcx4_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Container_navigate_to');
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'E_MALAHLENI_Container_rjh4k1fa_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Container_navigate_to');
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'E_MALAHLENI_Container_etckccy9_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Container_navigate_to');
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'E_MALAHLENI_Container_a54s4cra_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Container_navigate_to');
                                                                ...
                                                                return Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'E_MALAHLENI_Container_sqhlgu2l_ON_TAP');
                                                                      logFirebaseEvent(
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        FlutterFlowIconButton(
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            logFirebaseEvent('E_MALAHLENI_PAGE_youtube_ICN_ON_TAP');
                                                                            logFirebaseEvent('IconButton_launch_u_r_l');
                                                                            await launchURL('https://www.youtube.com/watch?v=4GI8-0Jx7nI');
                                                                          },
                                                                        ),
                                                                        Padding(
                                                                          padding: EdgeInsetsDirectional.fromSTEB(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('E_MALAHLENI_PAGE_spotify_ICN_ON_TAP');
                                                                              logFirebaseEvent('IconButton_launch_u_r_l');
                                                                              await launchURL('https://open.spotify.com/track/1AwtKupTgNc4tf6BvBXJCp?utm_source=chatgpt.com');
                                                                            },
                                                                          ),
                                                                        ),
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('E_MALAHLENI_PAGE_apple_ICN_ON_TAP');
                                                                              logFirebaseEvent('IconButton_launch_u_r_l');
                                                                              await launchURL('https://music.apple.com/za/song/abba-live/1788745557?utm_source=chatgpt.com');
                                                                            },
                                                                          ),
                                                                        ),
                                                                      ],
                                            ...
                                            children: List.generate(
                                              ...
                                              return Padding(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'E_MALAHLENI_Container_j8v5wjxo_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Container_navigate_to');
                                                                              ...
                                                                              children: [
                                                                                Expanded(
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: Text(
                                                                                      columnEventsRecord.dateDetails,
                                                                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                            fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                            color: FlutterFlowTheme.of(context).primaryText,
                                                                                            fontSize: 18.0,
                                                                                ...
                                                                                if (columnEventsRecord.time != null)
                                                                                  Padding(
                                                                                    padding: EdgeInsetsDirectional.fromSTEB(5.0, 0.0, 5.0, 0.0),
                                                                                    child: Text(
                                                                                      dateTimeFormat("Hm", columnEventsRecord.time!),
                                                                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                            fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                            color: FlutterFlowTheme.of(context).primaryText,
                                                                                            fontSize: 18.0,
