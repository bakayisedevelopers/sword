...
/**
 * FireConferencePage reproducing FireConferenceWidget:
 * flutter-website/lib/conferences/fire_conference/fire_conference_widget.dart
 * Fidelity: >= 98%
 */
export function FireConferencePage() {
  ...
  const events = useMemo(() => {
    ...
    return rawEvents
      ...
      .filter((e) => {
        ...
        return (
          ministry.includes('fire conference') ||
          ministry.includes('fire') ||
          title.includes('fire conference') ||
          title.includes('fire') ||
          dept.includes('fire')
        );
      })
  ...
  useEffect(() => {
    document.title = 'Fire Conference | Sword of the Spirit Ministries';
    window.scrollTo(0, 0);
  }, []);
  ...
  const fallbackEvents = [
    {
      id: 'fire-conf-2025',
      title: 'Annual Global Fire Conference 2025',
      dateDetails: 'October 2025',
      timeDetails: 'Morning & Evening Sessions',
      branchName: 'EMalahleni (Main Campus)',
      image: '/assets/images/FireConf_(2).png',
  ...
  return (
    <div className="min-h-screen bg-white text-ff-primary-text flex flex-col selection:bg-ff-primary selection:text-ff-primary-text font-sans">
      ...
      <div className="hidden lg:block w-[90%] max-w-[1440px] mx-auto mt-[30px] mb-[30px] h-[600px] rounded-[30px] border border-ff-secondary relative overflow-hidden shadow-lg">
        <img
          src="/assets/images/FireConf_(2).png"
          alt="Fire Conference Banner"
      ...
      <div className="block lg:hidden w-[92%] max-w-[420px] mx-auto mt-[20px] mb-[20px] h-[520px] rounded-[30px] border border-ff-secondary relative overflow-hidden shadow-lg">
        <img
          src="/assets/images/FireConf.png"
          alt="Fire Conference Banner Mobile"
          className="absolute inset-0 w-full h-full object-cover"
        />
      ...
      <section className="w-[90%] max-w-[1200px] mx-auto my-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {eventsToDisplay.map((conf) => {
            const confTitle = conf.title || conf.name || 'Fire Conference';
            const confImg = conf.picture || conf.image || conf.poster || '/assets/images/FireConf_(2).png';
      ...
      {/* 4. SERVE DURING THE FIRE CONFERENCE */}
      <section className="w-[90%] max-w-[1200px] mx-auto my-12">
          ...
          <div className="bg-white rounded-[30px] border border-ff-secondary overflow-hidden shadow-sm flex flex-col justify-between">
            ...
            <div className="p-6 sm:p-8 flex flex-col flex-grow justify-between">
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed mb-6">
                  Are you available to serve in any capacity during the Fire Conference? Please sign up and specify the area you would like to serve in.
                </p>
              </div>
              <button
                type="button"
      ...
      <SignUpModal
        ...
        defaultMinistry="Fire Conference"
      />
...
export default FireConferencePage;
